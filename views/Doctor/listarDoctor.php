        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            function actualizarFechaMinima() {
                ...
                if (fechaInicioInput.value) {
                    // Establecer fecha mínima para fecha fin (1 día después de la fecha inicio)
                    const fechaInicio = new Date(fechaInicioInput.value);
                    fechaInicio.setDate(fechaInicio.getDate() + 1); // Añadir un día
            ...
            function validarFechaFin() {
                ...
                // Verificar que la fecha fin sea posterior a la fecha de inicio
                if (fechaFin <= fechaInicio) {
                    markFieldAsInvalid(fechaFinInput);
                    addFieldHelpMessage(fechaFinInput, 'La fecha de fin debe ser posterior a la fecha de inicio');
                    return false;
                }
        ...
        `,
            ...
            function mostrarMensajeDiasHabilitados(diasHabilitados) {
                ...
                if (tablaHorarios) {
                    ...
                    let mensajeInfo = document.getElementById('mensajeDiasHabilitados');
                    if (!mensajeInfo) {
                        mensajeInfo = document.createElement('div');
