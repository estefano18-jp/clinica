                                ...
                                fetch(`../../../controllers/persona.controller.php?op=buscar_por_documento&nrodoc=${nrodoc}`)
                                    ...
                                    .then(personaData => {
                                        ...
                                        if (personaData.status && personaData.persona) {
                                            // Existe como persona pero no como paciente - Mostrar sus datos en los campos pero mantenerlos bloqueados
                                            Swal.fire({
                                                icon: 'info',
                                            ...
                                            // Cargar datos de la persona en el formulario (manteniendo los campos bloqueados)
